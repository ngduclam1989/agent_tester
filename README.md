...
│   └── commands/        # 16 kịch bản thực thi step-by-step (slash commands thật, gõ /ten-lenh)
├── plans/
...
#### 🧠 Chi Tiết 11 Kỹ Năng Chuyên Biệt (Skills)

Dưới đây là danh sách chi tiết các kỹ năng chuyên biệt nằm trong thư mục [`.claude/skills/`](.claude/skills/) được thiết lập sẵn trong dự án:

| Tên Skill                       | Đường dẫn chi tiết                                                     | Vai trò & Chức năng                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| :------------------------------- | :-------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **QA Automation Engineer** | [`qa_automation_engineer`](.claude/skills/qa_automation_engineer/SKILL.md) | **Master Skill** điều phối toàn bộ quy trình viết và chạy automation test.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **RBT Manual Testing**     | [`rbt_manual_testing`](.claude/skills/rbt_manual_testing/SKILL.md)         | Thiết kế manual test cases theo 2 chế độ:**QUICK** (sinh nhanh) hoặc **FULL RBT** (quy trình AI-RBT 6 bước có đánh giá rủi ro).                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **API Test Design**        | [`api_test_design`](.claude/skills/api_test_design/SKILL.md)               | Sinh Test Design (Markmap, 4-phase) và Manual Test Case (20 cột, chia block theo RBT) cho API khi**không có Swagger** — chỉ cần tài liệu PTTK/RSD/DB. Được `rbt_manual_testing` gọi tới khi phát hiện scope API.                                                                                                                                                                                                                                                                                                                                                                                                          |
...
Dưới đây là danh sách 16 workflow (kịch bản tự động hóa) được cấu hình dưới dạng slash commands trong thư mục [`.claude/commands/`](.claude/commands/):

| Slash Command                             | Đường dẫn kịch bản                                                                            | Vai trò & Mục đích                                                                                                                                                                                                                                                                 |
| :---------------------------------------- | :-------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/generate_requirements_from_website`   | [`generate_requirements_from_website`](.claude/commands/generate_requirements_from_website.md)     | Tự động phân tích giao diện và mã nguồn website để sinh tài liệu requirements chi tiết.                                                                                                                                                                                  |
| `/analyze_requirement_document`         | [`analyze_requirement_document`](.claude/commands/analyze_requirement_document.md)                 | Phân tích sâu các tài liệu yêu cầu (Jira Ticket, PDF, Word), tạo tài liệu phân tích nghiệp vụ kèm**Gap Review** đầy đủ (bảng finding `RR-NNN`, citation nguồn, khuyến nghị SẴN SÀNG/CẦN LÀM RÕ, phân loại tác động `TC`/`UX`/`Khác`). |
| `/generate_manual_testcases_rbt`        | [`generate_manual_testcases_rbt`](.claude/commands/generate_manual_testcases_rbt.md)               | Sinh bộ Manual Test Cases chuẩn nghiệp vụ theo quy trình AI-RBT 6 bước.                                                                                                                                                                                                         |
| `/generate_testcases_from_requirements` | [`generate_testcases_from_requirements`](.claude/commands/generate_testcases_from_requirements.md) | Chế độ QUICK: Sinh nhanh test cases từ requirements có sẵn (không qua quy trình đánh giá rủi ro).                                                                                                                                                                          |
| `/generate_automation_from_testcases`   | [`generate_automation_from_testcases`](.claude/commands/generate_automation_from_testcases.md)     | Tự động chuyển đổi các bước kiểm thử manual (Manual Test Cases) sang automation test scripts.                                                                                                                                                                               |
| `/generate_automation_from_ui_flow`     | [`generate_automation_from_ui_flow`](.claude/commands/generate_automation_from_ui_flow.md)         | Dò quét (crawl) luồng nghiệp vụ trên UI thực tế, thu thập locators và viết thẳng kịch bản automation.                                                                                                                                                                    |
| `/generate_application_test_plan`       | [`generate_application_test_plan`](.claude/commands/generate_application_test_plan.md)             | Khám phá toàn bộ ứng dụng web để xây dựng Test Plan tổng thể hoặc khung xương (skeleton) automation.                                                                                                                                                                    |
| `/generate_automation_framework`        | [`generate_automation_framework`](.claude/commands/generate_automation_framework.md)               | Khởi tạo cấu trúc dự án test automation hoàn chỉnh từ ban đầu.                                                                                                                                                                                                              |
| `/generate_locator`                     | [`generate_locator`](.claude/commands/generate_locator.md)                                         | Định vị và phân tích phần tử UI để sinh ra locator tối ưu nhất.                                                                                                                                                                                                           |
| `/generate_test_data`                   | [`generate_test_data`](.claude/commands/generate_test_data.md)                                     | Sinh test data đầu vào có cấu trúc (JSON, CSV, JS Object) để nạp vào automation scripts.                                                                                                                                                                                     |
| `/generate_cross_module_test_plan`      | [`generate_cross_module_test_plan`](.claude/commands/generate_cross_module_test_plan.md)           | Phân tích tích hợp đa module, sinh ma trận tổ hợp (Pairwise/Full Cartesian).                                                                                                                                                                                                   |
| `/generate_combinatorial_test_data`     | [`generate_combinatorial_test_data`](.claude/commands/generate_combinatorial_test_data.md)         | Sinh test data theo ma trận kết hợp bằng cách chạy pipeline thử nghiệm qua các trang UI.                                                                                                                                                                                      |
| `/generate_api_tests_from_swagger`      | [`generate_api_tests_from_swagger`](.claude/commands/generate_api_tests_from_swagger.md)           | Sinh kịch bản và script kiểm thử API tự động từ tài liệu Swagger/OpenAPI.                                                                                                                                                                                                   |
| `/analyze_flaky_tests`                  | [`analyze_flaky_tests`](.claude/commands/analyze_flaky_tests.md)                                   | Chạy chế độ phân tích và khắc phục lỗi của các ca kiểm thử hoạt động không ổn định.                                                                                                                                                                               |
...
```bash
# Cài đặt nhanh (ví dụ Google Sheet)
...
3. **Bắt đầu trò chuyện với AI trên Claude Code:**
   Khi mở dự án lên Claude Code, AI tự động nhận diện thư mục `.claude` và sẽ áp dụng ngay các Rule, Skill, Slash Command của **Anh Tester** đã thiết lập sẵn.
