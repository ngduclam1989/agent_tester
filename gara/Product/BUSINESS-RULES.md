...
| BR-AP-001..016, BR-PRC-001..017, BR-AP-CMN-*, CB-AP-001 | EP-INVENTORY-ACCOUNTING-PERIOD | FEAT-AP-* (5: LIST/CREATE/DETAIL/EDIT/DELETE), FEAT-PRC-* (5: LIST/CREATE/DETAIL/RECALC/DELETE) | `gf-accounting.knowledge-graph.yaml` (kỳ + BQGQ master), `gf-inventory.knowledge-graph.yaml` (Sổ tồn + phiếu — cross-boundary REST read) |
