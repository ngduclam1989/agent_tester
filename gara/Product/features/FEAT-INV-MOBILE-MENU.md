...
| 5 | **Tồn kho** | `FEAT-STK-LIST-V2` *(W06 — xem `EP-INVENTORY-STOCK-V2`)* | W06 | ❌ ẩn | ❌ ẩn | ❌ ẩn | ✅ |
...
- Design source: **Figma** (mobile only — registry `Product/ux/figma/figma-links.yaml` waves["03"] FEAT-INV-MOBILE-MENU).
