...
- Events: [gf-sales-events.md](../events/gf-sales-events.md)
- Data model: [gf-sales-data-model.md](../data/gf-sales-data-model.md)
- ADR: ADR-014 (Insurance Settlement ownership), ADR-015 (debt-summary)
- BR: BR-EP-INSURANCE-SETTLEMENT (VLD-INS-SO-*, BR-INS-SO-ADJ-*, BR-INS-SO-PS-*, BR-INS-DASH-*, §7 calculation); BR-GF-SALES-014/016
- Integration: [INTEG-EXT-gf-sales.md](../integrations/INTEG-EXT-gf-sales.md), [INTEG-EXT-gf-accounting.md](../integrations/INTEG-EXT-gf-accounting.md)
