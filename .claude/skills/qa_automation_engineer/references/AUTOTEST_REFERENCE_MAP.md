...
- Playwright TypeScript is the only supported stack for this project — use it for browser contexts,
  API request fixtures, trace/video, and modern web-first assertions.
