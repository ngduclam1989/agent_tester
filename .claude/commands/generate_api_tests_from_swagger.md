...
> - **`qa_automation_engineer`** (`.claude/skills/qa_automation_engineer/SKILL.md`) — Routing + API automation rules
> - **`test_data_generator`** (`.claude/skills/test_data_generator/SKILL.md`) — Sinh payload/data unique, traceable
