...
> - **`ui_debug_agent`** (`.claude/skills/ui_debug_agent/SKILL.md`) — Chạy UI flow, inspect DOM, evidence
> - **`smart_locator_agent`** (`.claude/skills/smart_locator_agent/SKILL.md`) — Sinh locator ổn định
> - **`qa_automation_engineer`** (`.claude/skills/qa_automation_engineer/SKILL.md`) — Sinh automation code + execution rules
> - **`test_data_generator`** (`.claude/skills/test_data_generator/SKILL.md`) — Sinh data unique/traceable khi flow tạo/sửa dữ liệu
> - **`framework_architect`** (`.claude/skills/framework_architect/SKILL.md`) — Dùng khi project chưa có framework
> - **Reference:** `.claude/skills/qa_automation_engineer/references/AUTOTEST_HANDOFF_CONTRACT.md`
> - **Reference:** `.claude/skills/qa_automation_engineer/references/AUTOTEST_REFERENCE_MAP.md`
