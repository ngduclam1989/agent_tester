...
> Trước khi mapping hoặc xuất bảng TC, đọc thêm `.claude/skills/rbt_manual_testing/references/tc-output-contract.md` để giữ đúng schema FULL RBT.
...
> Trước khi làm: đọc `plans/manual/06_template_mapping/prompt.txt` và `.claude/skills/rbt_manual_testing/references/tc-output-contract.md`.
