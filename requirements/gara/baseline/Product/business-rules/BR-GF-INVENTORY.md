...
| BR-INV-MENU-002 | Tile chỉ render khi sub-module tương ứng đã GA — **ẨN HOÀN TOÀN** tile chưa GA. KHÔNG hiển thị placeholder, KHÔNG badge "Sắp ra mắt". Hub W03 render đúng 2 tile (Sản phẩm + Nhóm vật tư); W04 thêm Tồn đầu kỳ; W05 thêm Phiếu nhập + Phiếu xuất; W06 đủ 6 tile (thêm **"Tồn kho"**). *(BA decision 2026-06-29: hide-only strategy.)* | Tile Visibility | FEAT-INV-MOBILE-MENU |
...
| BR-INV-MENU-004 | Tap tile → push route tới màn list sub-module + preserve back stack. Back từ sub-module quay về hub (không nhảy về root). Hub là pure client-side navigation — KHÔNG gọi BFF, KHÔNG fetch data. Riêng W06 tile **"Tồn kho"** push tới `FEAT-STK-LIST-V2` (Báo cáo tồn kho đến ngày) và không route tới NXT/thẻ kho trên mobile. | Navigation | FEAT-INV-MOBILE-MENU |
...
| 2026-07-21 | v4 — Clarify W06 mobile Stock navigation: tile **"Tồn kho"** được enable ở hub và push tới `FEAT-STK-LIST-V2` only; không route tới NXT/thẻ kho trên mobile. Đồng bộ `BR-STKV2-016`, `FEAT-INV-MOBILE-MENU` v4 và UX-FLOW-CATALOG v13. | Business Authority |
