...
# FEAT-TEN-002: Tenant Manage: hồ sơ năng lực, tài khoản Tenant, liên kết nhà xe, khoá/mở khoá
...
| Field | Value |
|---|---|
| Feature ID | `FEAT-TEN-002` |
| Title | Tenant Manage: hồ sơ năng lực, tài khoản Tenant, liên kết nhà xe, khoá/mở khoá |
...
| Evidence source | Confluence 21267177 |
...
**As** tenant management user, **I want** tenant manage: hồ sơ năng lực, tài khoản tenant, liên kết nhà xe, khoá/mở khoá, **so that** tôi hoàn thành nghiệp vụ thuộc epic `EP-COP-TENANT-MANAGEMENT` với dữ liệu trace được trong COP.

## 2. Acceptance Criteria

- [ ] **AC-1** (Khoá/mở khoá):
  - **Given** người dùng có quyền trong boundary `tenant-management`
  - **When** chọn khoá hoặc mở khoá trên bản ghi hợp lệ
  - **Then** hệ thống cập nhật trạng thái truy cập đúng rule và ghi nhận người thực hiện/thời gian.
- [ ] **AC-2** (Validation và quyền truy cập):
  - **Given** người dùng thiếu quyền hoặc dữ liệu đầu vào không hợp lệ
  - **When** thực hiện chức năng "Tenant Manage: hồ sơ năng lực, tài khoản Tenant, liên kết nhà xe, khoá/mở khoá"
...
- UX spec: `Product/ux/tenant-management-tenant-manage-ho-so-nang-luc-tai-khoan-tenant-lien-ket-nha-xe-khoa-mo-khoa.md`
- Wireframe: N/A
- Source: Confluence 21267177
...
- Source of truth chi tiết: Confluence 21267177.
